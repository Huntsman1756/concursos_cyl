...
(root/'public/candidatura.html').write_text('''<!doctype html><html lang="es"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>SALIDA CyL · Candidatura 2026</title><link rel="stylesheet" href="candidatura.css"><main><nav><a href="./">Abrir SALIDA CyL</a> · <a href="candidatura.pdf">Descargar memoria PDF</a></nav>'''+''.join(web)+'</main></html>\n',encoding='utf-8')
