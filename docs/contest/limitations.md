...
El objetivo de ampliar la cobertura está condicionado a evidencia: el freeze actual registra 17 cualificaciones distintas y deja 4 programas diferidos. El despliegue público está verificado para el commit `9f5125393aa826cbf8b882064afe822112fdb334`; la verificación de rutas y recursos queda registrada en `docs/contest/release-evidence.json`.
