...
El objetivo de ampliar la cobertura está condicionado a evidencia: el freeze actual registra 185 claves de programa con relación revisada y deja 2 programas diferidos. El despliegue público está verificado para el commit `ca8289ebe12c888af7765a212ce44b3754f838ca`; la verificación de rutas y recursos queda registrada en `docs/contest/release-evidence.json`.
