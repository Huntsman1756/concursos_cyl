...
El objetivo de ampliar la cobertura está condicionado a evidencia: el freeze actual registra 77 cualificaciones distintas y deja 0 programas diferidos. El despliegue público está verificado para el commit `90aba16a5bcef42ae6f966e9aaff9c53d82369aa`; la verificación de rutas y recursos queda registrada en `docs/contest/release-evidence.json`.
