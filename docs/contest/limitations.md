...
El objetivo de ampliar la cobertura está condicionado a evidencia: el freeze actual registra 113 cualificaciones distintas y deja 0 programas diferidos. GitHub Pages está verificado para el commit `7355bb1c05aecd7452ec82333652d5070927947e`; la URL canónica del VPS debe actualizarse antes de dar por cerrada la evidencia visual. La verificación de rutas y recursos queda registrada en `docs/contest/release-evidence.json`.
