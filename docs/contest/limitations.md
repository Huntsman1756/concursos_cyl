...
El objetivo de ampliar la cobertura está condicionado a evidencia: el freeze actual registra 36 cualificaciones distintas y deja 3 programas diferidos. El despliegue y la verificación pública aún están pendientes y no forman parte de este documento como hechos consumados.
