...
El objetivo de ampliar la cobertura está condicionado a evidencia: el freeze actual registra 39 cualificaciones distintas y deja 0 programas diferidos. El despliegue público está verificado para el commit `ed2583f6fbabcd73b9c07d20d222e0be4b0efa2d`; la verificación de rutas y recursos queda registrada en `docs/contest/release-evidence.json`.
