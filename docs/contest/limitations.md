...
El objetivo de ampliar la cobertura está condicionado a evidencia: el freeze actual registra 59 cualificaciones distintas y deja 0 programas diferidos. El despliegue público está verificado para el commit `e1f6d22cfe3baa4824ac8e4f68ada6829a441968`; la verificación de rutas y recursos queda registrada en `docs/contest/release-evidence.json`.
