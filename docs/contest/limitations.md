...
El objetivo de ampliar la cobertura está condicionado a evidencia: el freeze actual registra 48 cualificaciones distintas y deja 0 programas diferidos. El despliegue público está verificado para el commit `c72b891f302a6a189ed507e05a6b443366c841d7`; la verificación de rutas y recursos queda registrada en `docs/contest/release-evidence.json`.
