...
El objetivo de ampliar la cobertura está condicionado a evidencia: el freeze actual registra 113 cualificaciones distintas y deja 0 programas diferidos. El despliegue público está verificado para el commit `f55de804cc94b5d928484e846b933a9dea94b7d0`; la verificación de rutas y recursos queda registrada en `docs/contest/release-evidence.json`.
