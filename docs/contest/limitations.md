...
El objetivo de ampliar la cobertura está condicionado a evidencia: el freeze actual registra 13 cualificaciones distintas y deja 6 programas diferidos. El despliegue público está verificado para el commit `b71b3a8655d00672fd976dba0f04a81840e44de5`; la verificación de rutas y recursos queda registrada en `docs/contest/release-evidence.json`.
