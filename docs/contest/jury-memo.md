...
Los ocho conjuntos regionales tienen un uso visible en la interfaz y una copia normalizada dentro del snapshot `20260821144454118-a56e3eeaffa6`.
...
- Las 213 relaciones FP-ocupación publicadas cubren 81 cualificaciones distintas y 97 claves de modalidad; son cobertura revisada, no el universo completo de relaciones posibles.
