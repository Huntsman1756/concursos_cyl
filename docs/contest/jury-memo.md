...
Los ocho conjuntos regionales tienen un uso visible en la interfaz y una copia normalizada dentro del snapshot `20260821081317938-ed24cccf3125`.
...
- Las 143 relaciones FP-ocupación publicadas cubren 59 cualificaciones distintas y 72 claves de modalidad; son cobertura revisada, no el universo completo de relaciones posibles.
