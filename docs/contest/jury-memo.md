...
Los ocho conjuntos regionales tienen un uso visible en la interfaz y una copia normalizada dentro del snapshot `20260821162954121-087e3c5155c6`.
...
- Las 228 relaciones FP-ocupación publicadas cubren 86 cualificaciones distintas y 102 claves de modalidad; son cobertura revisada, no el universo completo de relaciones posibles.
