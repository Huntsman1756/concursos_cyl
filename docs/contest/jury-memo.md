...
Los ocho conjuntos regionales tienen un uso visible en la interfaz y una copia normalizada dentro del snapshot `20260821120933391-9bd4488f9029`.
...
- Las 196 relaciones FP-ocupación publicadas cubren 77 cualificaciones distintas y 93 claves de modalidad; son cobertura revisada, no el universo completo de relaciones posibles.
