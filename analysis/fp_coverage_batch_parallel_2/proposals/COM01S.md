...
*Documento generado por worker NAN (DeepSeek). No modifica datos curados. Solo lectura validada de `data/curated/occupations.json` y `analysis/fp_coverage_batch_parallel_2/sources/COM01S.txt`.*
