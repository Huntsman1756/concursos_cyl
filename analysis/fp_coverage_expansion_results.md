...
- Terminal attempts: 14 (11 completed, 3 deferred, 0 discarded).
- Truthful terminal distinct total: 16 (baseline 5 + 11 newly completed canonical bases).
- Target: 12; remaining gap: 0.
- Publication status: AGA01M and AGA03M and COM01B and COM02M and ELE01M and ELE03S and FME01M and FME02M and IMA02M and MAM01M and TMV01M are published in the current immutable snapshot; deferred attempts remain unpublished.
- Coverage rationale: The evidence-backed total exceeds the target by 4; completion covers AGA01M and AGA03M and COM01B and COM02M and ELE01M and ELE03S and FME01M and FME02M and IMA02M and MAM01M and TMV01M, while 3 terminal attempts remain deferred and unpublished.
...
- Total wall-clock minutes across attempt windows: 4651.65.
