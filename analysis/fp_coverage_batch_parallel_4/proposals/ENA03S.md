...
| --- | -------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | `Encargada / encargada de montaje de subestaciones eléctricas de instalaciones eólicas y fotovoltaicas.` | No hay aprobado para montaje específico de subestaciones eólicas/fotovoltaicas. Los candidatos genéricos (7314, 8209, 3123) no cubren la especialidad de subestación.                                                               |
