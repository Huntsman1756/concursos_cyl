# TMV03M — Electromecánica de maquinaria

**Review date:** 2026-08-21  
**TodoFP:** <https://www.todofp.es/que-estudiar/familias-profesionales/transporte-mantenimiento-vehiculos/electromecanica-maquinaria.html>  
...
|   Code | Reason                                                                                                                                |
| -----: | ------------------------------------------------------------------------------------------------------------------------------------- |
| `7401` | Mecánicos y ajustadores de vehículos de motor covers road vehicles, not the agricultural/industrial machinery boundary in the output. |
| `3126` | Técnicos en mecánica is a broader technician group and does not preserve the machinery mechanic boundary.                             |
| `7521` | Mecánicos y reparadores de equipos eléctricos is an electrical-equipment boundary, not machinery maintenance as such.                 |
| `3124` | Técnicos en electrónica is an electronic-equipment boundary and is not established by the output.                                     |
| `8321` | Operadores de maquinaria agrícola móvil describes operating machinery, not qualified electromechanical maintenance and repair.        |

Accessory sales, diagnosis, and supervisory interpretations remain
unpublished; no generic machinery alias is added.
